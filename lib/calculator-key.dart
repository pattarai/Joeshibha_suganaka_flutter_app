...
import 'package:suganaka1/key-controller.dart';
import 'package:suganaka1/key-symbol.dart';
...
class CalculatorKey extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    TextStyle style = Theme.of(context).textTheme.display1.copyWith(color: Colors.tealAccent);
